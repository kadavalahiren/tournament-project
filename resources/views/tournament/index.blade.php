...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        ...
        <form action="{{ route('start.tournament') }}" method="POST" class="bg-white p-6 rounded shadow">
            ...
            <button type="button" id="add-user" class="btn btn-primary bg-blue-500 text-white px-4 py-2 rounded">Add User</button>
            <button type="submit" class="btn btn-secondary text-white px-4 py-2 rounded">Start Tournament</button>
        </form>
    </div>
